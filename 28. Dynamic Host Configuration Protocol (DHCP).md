...
This process is often referred to as `DORA`, an acronym for `Discover, Offer, Request, and Acknowledge`. Below we see a breakdown of DORA. Before we explore the DORA steps in detail, let's first clarify the roles of the DHCP server and the DHCP client:
...
<img width="1885" height="1206" alt="image" src="https://github.com/user-attachments/assets/44e97f86-1db8-4ce7-ba3c-8efc97164222" />
